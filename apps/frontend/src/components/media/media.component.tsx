                ...
                >
                  ...
                  >
                    ...
                    <div className="w-full h-full rounded-[6px] overflow-hidden">
                      ...
                      ) : media.path.toLowerCase().indexOf('.pdf') > -1 ? (
                  ...
                  <div className="cursor-pointer rounded-[5px] w-[40px] h-[40px] border-2 border-tableBorder relative flex transition-all">
                    ...
                    <div className="w-full h-full relative group">
                      ...
                      {media?.path?.indexOf('mp4') > -1 ? (
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center bg-[#f5f5f5] rounded-[4px]">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6z" stroke="#999" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M14 2v6h6" stroke="#999" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          </svg>
                          <span style={{ fontSize: 8, color: '#c00', fontWeight: 600 }}>PDF</span>
                        </div>
                      ) : (
                        <img
